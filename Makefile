# ARM64 support for Azure Functions in Python
# Based on a solution provided in: https://github.com/Azure/azure-functions-python-worker/issues/915#issuecomment-1552394117
